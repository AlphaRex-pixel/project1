...
export default class ReadytoStart extends Component {
  render() {
    return (
        <Box sx={{display:"flex", flexDirection: "column", m:0}}>
        <Box sx={{ mx: 2, mt: 1}}>
    <Typography sx={{fontWeight: "bold", color: "primary.main"}} onChange={e=>console.log(e)}>Param Development - 1</Typography>
    ...
    <Box sx={{ display: "flex", justifyContent: "flex-start", alignItems: "center", mt: 2}}>
        ...
        <Typography sx={{fontSize:"10px",fontWeight: "bold",color: '#ffeb3b', ml: 1}}>Ready to Start</Typography>
    </Box>
