  ...
  render() {
    return (
        <Box sx={{display:"flex", flexDirection: "column", m:0}}>
            <Box sx={{ mx: 2, mt: 1}}>
        <Typography sx={{fontWeight: "bold", color: "primary.main"}} onChange={e=>console.log(e)}> IT Developers Support - 1</Typography>
        ...
        <Box sx={{ display: "flex", justifyContent: "flex-start", alignItems: "center", mt: 2}}>
            ...
            <Typography sx={{fontSize:"10px",fontWeight: "bold",color: '#ffeb3b', ml: 1}}>To Do</Typography>
        </Box>
